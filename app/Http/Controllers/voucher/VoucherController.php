    ...
    public function store(Request $request)
    {
        try {
            $params = $request->validate([
                ...
                'title'=>'Tên voucher là bắt buộc',
                'discount_type'=>'Loại giảm giá là bắt buộc',
                'discount_value'=>'Mức giảm giá là bắt buộc',
                'start_date'=>'Ngày bắt đầu là bắt buộc',
                'end_date'=>'Ngày kết thúc là bắt buộc',
                'usage_limit'=>'Giới hạn số lần sử dụng là bắt buộc',
                'usage_per_user'=>'Giới hạn lượt dùng mỗi người là bắt buộc',
