                    ...
                    <form action="{{ route('voucher.update', $voucher->id) }}" method="POST">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="w-50">
                                ...
                                <input type="text" class="form-control w-50 mb-3 @error('title') is-invalid @enderror"
                                    id="basiInput" name="title" value="{{ $voucher->title }}">
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="">
                            ...
                            <select name="user_voucher_limit" class="form-select mb-3 w-25" id="user_voucher_limit"
                                ...
                                <option value="3" {{ $voucher->user_voucher_limit == 3 ? 'selected' : '' }}>Người dùng
                                    mã ưu đãi cụ thể</option>
                            </select>
                        </div>
                            ...
                            <div class="d-flex gap-3">
                                <div class="col-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ $voucher->min_accumulated_points }}"
                                        placeholder="Nhập điểm tích lũy nhỏ">
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ $voucher->max_accumulated_points }}"
                                        placeholder="Nhập điểm tích lũy lớn">
                                </div>
                            </div>
                        </div>
                        <div id="conditionalUserField"
                            style="display: {{ $voucher->user_voucher_limit == 3 ? 'block' : 'none' }};">
